...
testarray = []
for filename in os.listdir("wallmart/data"):
    if filename.endswith(sys.argv[1]+"_json.json"):                     # LEE ARCHIVO JSON PARA EL PERIODO PASADO POR PARAMETRO
        filepath = os.path.join('wallmart/data', filename)
