...
if not df_E0.empty:
    ...
    df_SCORE.to_csv("src/report/E0_TABLAPOSICION_"+sys.argv[1]+".csv", index = False, header=True)
...
if not df_PL.empty:
    ...
    df_SCORE.to_csv("src/report/PL_TABLAPOSICION_"+sys.argv[1]+".csv", index = False, header=True)   
...
if not df_E0.empty:
    ...
    df_INDGOL.to_csv("src/report/E0_INDGOL_"+sys.argv[1]+".csv", index = False, header=True)
...
if not df_PL.empty:
    ...
    df_INDGOL.to_csv("src/report/PL_INDGOL_"+sys.argv[1]+".csv", index = False, header=True)   
...
if not df_E0.empty:
    ...
    df_CANGOLCONTRA.to_csv("src/report/E0_CANGOLCONTRA_"+sys.argv[1]+".csv", index = False, header=True)
...
if not df_PL.empty:
    ...
    df_CANGOLCONTRA.to_csv("src/report/PL_CANGOLCONTRA_"+sys.argv[1]+".csv", index = False, header=True)
