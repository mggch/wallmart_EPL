...
##   E0_TABLAPOSICION.csv: REPORTE DE TABLA DE POSICIONES DIVISION E0 POR TEMPORADA
##   PL_TABLAPOSICION.csv: REPORTE DE TABLA DE POSICIONES DIVISION PREMIER LEAGUE POR TEMPORADA
